class AppConstants {
  ...
  static const Map<int, dynamic> deviceTypes = {
    1: {
      //In_Wall_Outlet
      'dSub': {
        0: {
        ...
        1: {
          'nSen': 9,
          'senT': {0: 37, 1: 4, 2: 38, 3: 39, 4: 40, 5: 41, 6: 42, 7: 43, 8: 5},
        },
      }
    },
    2: {
  ...
  static const Map<int, dynamic> sensorTypeId = {
    0: 'State',
    1: 'light',
    2: 'color',
    3: 'ultraviolet',
  ...
  static const Map<dynamic, int> sensorTypeIdRevers = {
    'State': 0,
    'light': 1,
    'color': 2,
    'ultraviolet': 3,
