    ...
    return SafeArea(
      ...
      child: Column(
          ...
          children: [
                        ...
                        onSelected: (String? value) {
                          ...
                          setState(() {
                            ...
                            if (sensorTypeValue == "00") {
                              setState(() {
                                typeOfThreshold = <String>["Below", "Above"];
                                thresholdType = typeOfThreshold.first;
                              });
                            } else {
                              setState(() {
            ...
            dataDevice.isActivation == 1 && sensorTypeValue == "00"
                ? Center(
                    child: Switch(
                      value: isSwitched,
                            ...
                            FilledButton(
                                onPressed: () {
                                  ...
                                  if (dataDevice.isActivation == 2) {
                                    ...
                                    threshParam1 =
                                        hexPadding(int.parse(actionValue));
                                    threshParam2 = '00000000';
                                  }
                                  ...
                                  if (_thresholdType == 1 ||
                                      _thresholdType == 2) {
                                    inStartThresh =
                                        int.parse(_startValueController.text);
                                  ...
                                  int hStartTime =
                                      int.parse((inStartTime.substring(0, 2)));
                                  int mStartTime =
                                      int.parse(inStartTime.substring(3));
                                  int startTimeinSec =
                                      (3600 * hStartTime) + (60 * mStartTime);

                                  secStartTime = hexPadding(startTimeinSec);

                                  int hEndTime =
                                      int.parse((inEndTime.substring(0, 2)));
                                  int mEndTime =
                                  ...
                                  meshThreshold.sendSetThreshold(
